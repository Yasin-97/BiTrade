...
const Landing = () => {
  return (
    <div className="h-[calc(100vh-64px)] flex items-center flex-col w-full">
      <div className="flex flex-col items-center justify-center gap-12 h-4/5">
      ...
      <div className="white-glassmorphism rounded-none border-0 mf:border mf:border-x-0 w-full p-4 flex justify-center ">
        <ul className=" w-full mf:w-2/3 flex justify-around flex-wrap mf:flex-nowrap ">
